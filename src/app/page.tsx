...
//       <div className="bg-white/80 backdrop-blur-md shadow-xl rounded-2xl p-10 max-w-2xl w-full text-center border border-green-200">
//         <h1 className="text-4xl font-bold text-green-700 mb-4">Kanul Riza Institute</h1>
//         <p className="text-gray-700 text-lg mb-8">
//           Welcome to the official donation portal of <span className="font-semibold">Kanul Riza Institute</span>. Support our mission with your generous contributions.
//         </p>
...
//           <Link
//             href="/admin_login"
//             className="px-6 py-3 rounded-xl bg-white text-green-600 font-semibold border border-green-600 shadow hover:bg-green-50 transition"
//           >
//             Admin Login
//           </Link>
//         </div>
...
//         {/* About Section */}
//         <div className="mt-10 bg-green-50 p-8 rounded-2xl shadow border border-green-200 text-left">
//           <h2 className="text-3xl font-bold text-green-700 mb-4">What is Kanul Riza?</h2>
//           <p className="text-gray-700 leading-relaxed mb-4">
//             Kanul Riza is an Islamic educational and welfare platform dedicated to spreading the teachings of Islam and supporting the Muslim community. Our mission covers multiple areas of Islamic service, including providing Islamic knowledge, educating students in boys and girls madrasas, and constructing Islamic buildings.
//           </p>
//           <ul className="list-disc pl-6 text-gray-700 space-y-2">
//             <li>Educating students in boys’ and girls’ madrasas</li>
//             <li>Constructing masjids and Islamic buildings</li>
//             <li>Providing Islamic books and literature</li>
//             <li>Offering Islamic talimat and guidance</li>
//             <li>Supporting Muslims by resolving their social and spiritual issues</li>
//             <li>Helping improve the conditions of Muslims through welfare work</li>
//             <li>Providing amaliyat to help resolve Islamic concerns</li>
//           </ul>
//         </div>

//         {/* Social Media Section */}
//         <div className="mt-10 flex flex-col items-center gap-4">
//           <h3 className="text-2xl font-semibold text-green-700">Follow Us</h3>
//           <div className="flex gap-6 text-green-600 text-3xl">
//             {/* Using react-icons */}
//             <a href="#" className="hover:text-green-800 transition"><i className="ri-facebook-circle-fill"></i></a>
//             <a href="#" className="hover:text-green-800 transition"><i className="ri-instagram-fill"></i></a>
//             <a href="#" className="hover:text-green-800 transition"><i className="ri-twitter-x-line"></i></a>
//             <a href="#" className="hover:text-green-800 transition"><i className="ri-youtube-fill"></i></a>
//           </div>
//         </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@kanulriza.org</p>
                    </div>
                  </div>
                </div>
              </div>
